  ...
  return (
      ...
      <><div>
        ...
        <div className="MinimumPrice">
          Maximum Price: <input type="number" placeholder="Minimum price" name="priceFilter"  onChange={(e)=>{setMinPriceFilter(e.target.value)}} />
        </div>
        <div className="MaximumPrice">
          Minimum Price: <input type="number" placeholder="Maximum price" name="priceFilter"  onChange={(e)=>{setMaxPriceFilter(e.target.value)}} />
        </div>
        <div className="Make">
